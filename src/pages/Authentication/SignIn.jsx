...
const SignIn = () => {
  ...
  const handleLogin = () => {
    ...
    Services.handleUnauthorizedError = () => {
      setInvalid(true)
      setError(Services.errors.message)
    }
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full rounded-lg border bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary ${invalid ? 'border-danger':'border-stroke'}`}
                    />
                  </div>
                  {
                    invalid && <p className='text-danger text-xs mt-1'>{error}</p>
                  }
                </div>
                ...
                <button onClick={handleLogin} className="mb-5 w-full cursor-pointer rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90">
                  Sign In
                </button>
