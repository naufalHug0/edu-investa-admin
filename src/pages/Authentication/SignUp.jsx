  ...
  const handleRegister = () => {
    ...
    Services.handleSuccess = () => {
      Modal.show({
        ...
        options: [
          { title: 'Lanjut', type: 'primary', url: '/auth/signin' }
        ]
      })
    }
        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">EduInvesta</span>
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full rounded-lg border ${invalid && errors?.name ? 'border-danger':'border-stroke'} bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary`}
                    />
                  ...
                  {
                    (invalid && errors?.name) && <p className='text-danger text-xs mt-1'>{errors.name[0]}</p>
                  }
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full rounded-lg border ${invalid && errors?.username ? 'border-danger':'border-stroke'} bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary`}
                    />
                  ...
                  {
                    (invalid && errors?.username) && <p className='text-danger text-xs mt-1'>{errors.username[0]}</p>
                  }
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full rounded-lg border ${invalid && errors?.email ? 'border-danger':'border-stroke'} bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary`}
                    />
                  ...
                  {
                    (invalid && errors?.email) && <p className='text-danger text-xs mt-1'>{errors.email[0]}</p>
                  }
                </div>
                ...
                <div className="mb-7">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full rounded-lg border ${invalid && errors?.password ? 'border-danger':'border-stroke'} bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary`}
                    />
                  ...
                  {
                    (invalid && errors?.password) && <p className='text-danger text-xs mt-1'>{errors.password[0]}</p>
                  }
                </div>

                <button onClick={handleRegister} className="mb-5 w-full cursor-pointer rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90">
                  Buat Akun
                </button>
