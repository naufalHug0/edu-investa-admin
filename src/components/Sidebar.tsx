  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <p className='text-xl text-white font-bold'>EduInvesta Admin</p>
        </NavLink>
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {() => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" className="bi bi-controller" viewBox="0 0 16 16">
              ...
              <li>
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" className="bi bi-lightning-charge" viewBox="0 0 16 16">
              ...
              <li>
                <NavLink
                  to="/shorts"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('shorts') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" className="bi bi-file-play" viewBox="0 0 16 16">
              ...
              <li>
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" className="bi bi-collection-play" viewBox="0 0 16 16">
