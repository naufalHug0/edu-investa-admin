...
const TableCourse = ({ cols, rows }) => {
    const getMinuteSeconds = (seconds) => {
        return { minute: Math.floor(seconds / 60), second: seconds % 60 }
    }

    const formatSecondsToTimeString = (seconds) => {
        const {minute, second} = getMinuteSeconds(seconds)
                ...
                rows.map((row,i) => {
                    ...
                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                        ...
                        <button className="hover:text-primary">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
